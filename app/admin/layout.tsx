...
// Admin shell: auth/elevation gate + sidebar chrome, hoisted out of
// AdminShell.tsx (which every one of the 18 admin pages used to mount
// individually) into a real layout so it persists across in-app navigation
// instead of re-running its "Checking access…" check on every single page
// load. AdminShell.tsx is now a thin per-page title setter — see
// admin-title.tsx for how a page's title reaches the header rendered here.
//
