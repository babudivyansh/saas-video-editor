...
const sections = [
  ...
  { id: "enrollment", title: "Enrollment in the Program" },
  { id: "obligations", title: "Affiliate Obligations" },
  { id: "approved-methods", title: "Approved Promotional Methods" },
  { id: "prohibited", title: "Prohibited Activities" },
  { id: "commission", title: "Commission & Payment" },
  { id: "tracking", title: "Tracking & Attribution" },
...
export default function AffiliateTosPage() {
  return (
    <LegalPage title="Affiliate Terms of Service" lastUpdated="June 14, 2026" sections={sections}>
      ...
      <h2 id="enrollment">Enrollment in the Program</h2>
      <p>
      ...
      <p>
        Upon approval, you will receive a unique referral link and access to our affiliate
        dashboard. Approval is at our sole discretion, and we may decline applications
      ...
      <p>
        ...
        from the Program and forfeiture of any unpaid commissions:
      </p>
      <ul>
      ...
      <h2 id="commission">Commission & Payment</h2>
      ...
      <p>
        ...
        referral link; (b) the purchase was not later refunded; and (c) the purchase was not
        made fraudulently or in violation of these Affiliate Terms.
      </p>
      ...
      <p>
        A minimum balance of ₹500 (or equivalent) must be accumulated before a payout is
        initiated. If your balance does not meet the threshold, it carries over to the next
        payment period. Commission balances for terminated affiliates will be paid out at the
        next scheduled payment date, provided the minimum threshold is met and no violations
      ...
      <p>
        ...
        the revised terms, you must exit the Program before the effective date.
      </p>
