...
function Footer() {
  const columns = [
    {
      title: "Workflows",
      links: ["Faceless Videos", "YouTube Shorts", "TikTok Automation", "Reels Generator", "Podcast Clips"],
    },
    {
      title: "AI Tools",
      links: ["Script Writer", "AI Voiceover", "Karaoke Captions", "Auto Editing", "Background Generator"],
    },
    {
      title: "Free Tools",
      links: ["Script Generator", "Caption Maker", "Thumbnail Maker", "Video Trimmer", "Text to Speech"],
    },
    {
      title: "Product",
      links: ["Pricing", "Dashboard", "API Docs", "Changelog", "Status"],
    },
    {
      title: "Legal",
      links: ["Privacy Policy", "Terms of Service", "Cookie Policy", "GDPR", "Refund Policy"],
    },
  ];
    ...
    <footer className="bg-gray-900 text-gray-400">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-10 mb-14">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed mb-5">
              The #1 AI faceless video generator. Turn any topic into a viral short-form video in seconds.
            </p>
            <div className="flex items-center gap-3">
              {[
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-gray-600">Built with Next.js · Powered by Gemini AI · ElevenLabs voices</p>
        </div>
      </div>
    </footer>
  );
