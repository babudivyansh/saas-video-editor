            ...
            <>
              ...
              {(accounts ?? []).length === 0 ? (
                <div className="bg-white border border-dashed border-gray-200 rounded-2xl p-12 text-center">
                  <p className="text-sm font-medium text-gray-500">No accounts connected yet</p>
                  <p className="text-xs text-gray-400 mt-1">Connect a platform above to start tracking your analytics.</p>
                </div>
              ) : (
