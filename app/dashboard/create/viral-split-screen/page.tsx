    ...
    <div className="px-8 pt-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-bold text-fg">Vertical Split Screen Video</h1>
        </div>
      </div>
    ...
    >
      ...
      <div className="space-y-1 p-3">
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <a href={premiumUrl} target="_blank" rel="noopener noreferrer" onClick={e => e.stopPropagation()} className="w-full rounded-lg border border-line p-2 text-center text-sm text-fg-muted hover:text-fg transition-colors block">
