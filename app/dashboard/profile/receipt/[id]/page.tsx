    ...
    <div className="min-h-screen bg-gray-100 py-12 px-4 print:bg-white print:py-0">
      <div className="max-w-lg mx-auto">
        ...
        <div className="flex items-center justify-between mb-6 print:hidden">
          <Link href="/dashboard/profile/payment-history" className="text-sm font-semibold text-gray-500 hover:text-gray-800 inline-flex items-center gap-1.5">
            ...
            <>
              ...
              <div className="flex items-center justify-between pt-6 border-t border-gray-100">
                <div>
                  ...
                  <span className="inline-block mt-1 text-[10px] font-semibold text-green-700 bg-green-100 px-2 py-0.5 rounded-full capitalize">
                    {purchase.status}
                  </span>
                </div>
                <p className="text-2xl font-black text-gray-900">{formatINR(purchase.amountInPaise)}</p>
              </div>
