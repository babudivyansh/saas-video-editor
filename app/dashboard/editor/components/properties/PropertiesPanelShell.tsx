...
import type { AudioClip, CaptionClip, ImageClip, TextClip, VideoClip } from "@/lib/editor/types";
import { useEditorStore } from "../../store/editorStore";
import { Tabs, type TabItem } from "../ui";
import { CAPTION_TAB_ITEMS, IMAGE_TAB_ITEMS, TEXT_TAB_ITEMS, VIDEO_TAB_ITEMS } from "./tabConfig";
...
import CaptionClipProps from "./CaptionClipProps";
...
export function CaptionProperties({ clip }: { clip: CaptionClip }) {
  const [activeTab, setActiveTab] = useClipTab(clip.id, CAPTION_TAB_ITEMS);
  return (
    <TabbedShell items={CAPTION_TAB_ITEMS} activeTab={activeTab} onChange={setActiveTab} layoutId="properties-tabs-caption">
      <CaptionClipProps clip={clip} activeTab={activeTab} />
    </TabbedShell>
  );
}
