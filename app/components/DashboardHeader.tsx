        ...
        <NavDropdown label="Features" width={860} align="screen">
          <div className="grid grid-cols-4 gap-0 p-3">
            ...
            <div className="col-span-2 p-2 border-l border-gray-100">
              <p className="px-3 mb-1 text-[11px] font-bold uppercase tracking-widest text-brand">AI Tools</p>
            ...
            <div className="rounded-2xl bg-gradient-to-b from-tint-fuchsia to-transparent p-2 border-l border-gray-100">
              <p className="px-3 mb-1 text-[11px] font-bold uppercase tracking-widest text-accent-violet">Free Tools</p>
              <div className="space-y-0.5">
